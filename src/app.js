...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(yield mturk.getAccountBalance());
            let params = {
        ...
        `,
            ...
            console.log(yield mturk.createHIT(params));
            console.log(yield mturk.listHITs());
            console.log(yield mturk.listWorkersWithQualificationType("xxxx")); //
